...
export class CourseSectionController {
  ...
  async find(
    ...
    return this.courseRepository.section(id).find(filter);
  }
  ...
  async create(
    ...
    return this.courseRepository.section(id).create(section);
  }
  ...
  async patch(
    ...
    return this.courseRepository.section(id).patch(section, where);
  }
  ...
  async delete(
    ...
    return this.courseRepository.section(id).delete(where);
  }
}
